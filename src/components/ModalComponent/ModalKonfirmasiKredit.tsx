...
export function ModalShowKonfirmasiAngkaKredit({
  isOpen,
  setIsOpen,
  children,
  form,
            ...
            <tbody>
              <tr className="transition-all ease-in hover:cursor-pointer">
                ...
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form.watch('idRiwayatJabatanString') ?? '-'}
                </td>
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form.watch('idRiwayatJabatanString') ?? '-'}
                </td>
              ...
              <tr className="transition-all ease-in hover:cursor-pointer">
                ...
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form.watch('bulanMulaiPenilaian') ?? '-'} /{' '}
                  {form.watch('tahunMulaiPenilaian') ?? '-'} -{' '}
                  {form.watch('bulanSelesaiPenilaian') ?? '-'} /{' '}
                  {form.watch('tahunSelesaiPenilaian') ?? '-'}
                </td>
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form.watch('bulanMulaiPenilaian') ?? '-'} /{' '}
                  {form.watch('tahunMulaiPenilaian') ?? '-'} -{' '}
              ...
              <tr className="transition-all ease-in hover:cursor-pointer">
                ...
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form.watch('kreditPenunjangBaru') ?? '-'}
                </td>
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form.watch('kreditPenunjangBaru') ?? '-'}
                </td>
              ...
              <tr className="transition-all ease-in hover:cursor-pointer">
                <th className="border bg-sim-pale-primary px-24 py-12 text-left align-middle leading-medium text-sim-dark">
                  Apakah angka kredit pertama?
                </th>
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form?.watch('isAngkaKreditPertama') === '1'
                    ? 'Ya'
                    : 'Tidak' ?? '-'}
                </td>
                <td className="border px-24 py-12 align-middle leading-medium">
