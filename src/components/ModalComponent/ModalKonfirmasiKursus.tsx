...
export function ModalShowKonfirmasiKursus({
  isOpen,
  setIsOpen,
  children,
  form,
          ...
          <table className="flex-1 border-collapse rounded-3x bg-[#fcfcfc] text-24">
            ...
            <tbody>
              ...
              <tr className="transition-all ease-in hover:cursor-pointer">
                ...
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form?.watch('tanggalSelesaiKursus') ?? '-'}
                </td>
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form.watch('tanggalSelesaiKursus') ?? '-'}
                </td>
              ...
              <tr className="transition-all ease-in hover:cursor-pointer">
                ...
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form?.watch('institusiPenyelenggara') ?? '-'}
                </td>
                <td className="border px-24 py-12 align-middle leading-medium">
                  {form.watch('institusiPenyelenggara') ?? '-'}
                </td>
